    ...
    Plugin.prototype = {
        init: function () {
            ...
            if($.iPhone || $.iPad || $.Android || self.options.disabled){
                ...
                this.$li.css({position:'relative', '-webkit-transform': 'none'});
            ...
            } else if($.browser.mozilla || $.browser.msie || $.browser.webkit) {
                this.scrollEl = $('html');
            } else {
                this.scrollEl = $('body');
            }
        ...
        setDimensions: function(){
            ...
            this.$li.each(function(index) {
                ...
                if(cover){
                    ...
                    $self.css({minHeight: $self.children().outerHeight(), zIndex: 999-index})
        ...
        setEvents: function() {
            ...
            if(self.options.curtainLinks && !self.options.mobile){
            ...
            if(self.options.curtainLinks && $(document).width()<=700){
                $(self.options.curtainLinks).on('click', function(e){
                	$('.b-head__menu-close').hide();
